    ...
    return (
        <Drawer open={manageOpen} onOpenChange={setManageOpen} >
            <DrawerContent
                ...
                {/* HEADER */}
                <DrawerHeader className="flex flex-row justify-between items-center px-4 pt-5 pb-4 border-b border-[#C9C9C9]">
                    <DrawerTitle className="text-[#053E54] font-bold text-[14px] uppercase">
                        Choose Option
                    </DrawerTitle>

                    <DrawerClose className="cursor-pointer outline-none">
                        <X size={26} className="text-[#053E54]" />
                    </DrawerClose>
                </DrawerHeader>
                ...
                <div className="px-4 py-4">
                    ...
                    {/* <div className="first:pt-0 pt-5 pb-5 last:pb-0 border-b border-[#C9C9C9] last:border-0">
                            <button
                                ...
                                <span className="text-start text-sm text-[#053E54] font-semibold">Manage Documents</span>
                            </button>
                        </div> */}
                    <div className="first:pt-0 pt-5 pb-5 last:pb-0 border-b border-[#C9C9C9] last:border-0">
                        <button
                    ...
                    <div className="first:pt-0 pt-5 pb-5 last:pb-0 border-b border-[#C9C9C9] last:border-0">
                        <button
                            ...
                            <span className="text-start text-sm text-[#053E54] font-semibold ">
