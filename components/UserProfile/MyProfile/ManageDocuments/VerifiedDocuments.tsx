...
export default function VerifiedDocuments({ setOpenManageDocuments }: VerifiedDocumentsProps) {
    return (
        <>
                ...
                <div className="xs:pb-0 pb-0 flex flex-col justify-between xs:h-auto h-full">
                    <div>
                        <div className="relative xs:text-start text-center">
                            <h2 className="text-md xs:text-[23px] font-bold bg-gradient-to-r from-[#053E54] to-[#057C72] bg-clip-text text-transparent xs:mb-4 inline-block">Updated Documents!</h2>
                        </div>
                        <p className="text-[#666666] xs:text-[18px] text-sm font-400 xs:text-start text-center xs:mb-6">Your documents has been updated. If the document have any issues, Our executive will get back to you</p>
                    </div>
