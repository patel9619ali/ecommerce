...
export default function VerifiedEmail({ setOpenChangeEmail }: VerifiedEmailProps) {
    return (
        <>
                ...
                <div className="xs:pb-0 pb-0 flex flex-col justify-between xs:h-auto h-full">
                    <div>
                        <div className="relative xs:text-start text-center">
                            <h2 className="text-md xs:text-[23px] font-bold bg-gradient-to-r from-[#053E54] to-[#057C72] bg-clip-text text-transparent xs:mb-4 inline-block">Your Email Verified!</h2>
                        </div>
                        <p className="text-[#666666] xs:text-[18px] text-sm font-400 xs:text-start text-center xs:mb-6">Your email address has been verified, Thanks!</p>
                    </div>
