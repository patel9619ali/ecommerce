    ...
    return (
        <>
            <aside className="md:block hidden md:sticky md:top-25 w-full h-max p-5 bg-white rounded-[20px] border border-[#C9C9C9]">
                ...
                <LoadingLink href={`${process.env.NEXT_PUBLIC_APP_BASE_URL}user-profile/my-profile`}
            ...
            <div className="md:hidden block">
                <Card className="mb-5 w-full h-max p-5 bg-white rounded-[20px] border-none shadow-none">
                    <CardContent className="p-0">
