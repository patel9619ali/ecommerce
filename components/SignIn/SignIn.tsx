      ...
      <div className="bg-white p-6 rounded-md w-full max-w-sm shadow space-y-4">
        ...
        {!showTwoFactor && (
          <>
            ...
            <Button
              variant="outline"
              className="cursor-pointer w-full bg-[#fff] text-[#000] flex items-center"
              onClick={() => onClick("google")}
            >
              <span className="text-[14px]">Sign in with Google</span>
              <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="-3 0 262 262" preserveAspectRatio="xMidYMid">
                ...
                <path d="M130.55 50.479c24.514 0 41.05 10.589 50.479 19.438l36.844-35.974C195.245 12.91 165.798 0 130.55 0 79.49 0 35.393 29.301 13.925 71.947l42.211 32.783c10.59-31.477 39.891-54.251 74.414-54.251" fill="#ff0000"/>
              </svg>
            </Button>
