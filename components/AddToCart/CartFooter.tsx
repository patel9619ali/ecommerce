        ...
        <>
            <div className='sticky bottom-[0]'>
                <div className='flex flex-col gap-3 items-center mt-5 justify-between'>
                    ...
                    <LoadingLink href={`/checkout`} onClick={onCheckout} className='py-2 cursor-pointer uppercase bg-[#fff] px-4 font-[700] w-[250px] text-[#000000f0] text-[14px] rounded-md text-center'>Check out - ₹ {total}</LoadingLink>
                </div>
            </div>
        </>
    )
